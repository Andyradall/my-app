...
<section class="bg-grey-100 font-euclid relative">
	<div class="max-w-2xl mx-auto flex justify-between px-2 py-4 bg-grey-100">
		<div class="flex-1 flex flex-col p-8 absolute left-0">
			<a href="/work/karrierestart" class="flex flex-col items-start">
				<ul>
					<li
					...
					>
						<svg
							...
							width="24"
						>
							<path d="M401.196-232.348 153.304-480l247.892-247.652 63.652 65.174L327.87-525.5h478.826v91H327.87l136.978 136.978-63.652 65.174Z" />
						</svg>
						Prev
					</li>
					<li class="font-normal text-grey-800 hover:text-grey-700 text-2xl">Karrierestart</li>
				</ul>
			</a>
		</div>

		<div class="flex-1 flex flex-col p-8 absolute right-0">
			<a href="/work/smab" class="flex flex-col items-end">
				<ul>
					<li
						class="flex items-center uppercase text-lg text-grey-700 hover:text-grey-700 font-medium"
					>
						...
						<svg
							...
							width="24"
						>
							<path d="m560.239-232.348-63.652-65.174L633.565-434.5H151.869v-91h481.696L496.587-662.478l63.652-65.174L808.131-480 560.239-232.348Z" />
						</svg>
					</li>
