...
<svg class="full-svg-bg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 800" preserveAspectRatio="none">
...
.noise-overlay::before {
    ...
    z-index: -2; /* Stacked above the noise */
}  
