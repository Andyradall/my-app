...
<article class="max-w-2xl mx-auto p-4">
    ...
    <p class="mb-4">Article intro or summary...</p>
    <div class="prose lg:prose-lg">
        <!-- Main article content here -->
    </div>
    <!-- Other components like image galleries, quotes, etc. -->
</article>

<article>
<section class="grid max-w-[1297px] col-span-12 md:col-span-8 my-10 py-10">
...
<section id="first" class="pageSection font-euclid bg-grey-800 text-white py-8">
	<div class="max-w-7xl mx-auto px-16">
		<div class="grid grid-cols-12 gap-x-[24px]">
			...
			<div class="col-span-12 md:col-start-3 md:col-span-8">
				<h2 class="text-3xl font-medium">Exploring Designmaskinen</h2>
...
<section class="font-euclid bg-grey-800 text-white py-8">
	<div class="max-w-7xl mx-auto px-16">
		<div class="grid grid-cols-12 gap-x-[24px]">
			<div class="col-span-12 md:col-start-3 md:col-span-8">
		<p class="font-euclid text-base align-center">Mapping the Customer Journey</p>
		<h3 class="font-euclid text-lg font-medium">Focus on Admin User Experience</h3>
		<p class="font-euclid text-base align-center">
	...
	<div>
		<h2 class="font-euclid text-3xl font-bold text-grey-50">Streamlining the Architecture</h2>
		<h3 class="font-euclid text-xl font-medium">Embracing Simplicity</h3>
		<p class="font-euclid text-base align-center text-grey-50">
