<script>
	...
	onMount(() => {
		lightGallery(document.getElementById('medium-zoom-demo'), {
...
<article id="medium-zoom-demo" class="mx-auto font-euclid text-grey-800" in:fade={{ duration: 2700 }}>
	...
	<section id="first" class="pageSection bg-grey-800 text-grey-100 py-10 md:pt-32 md:pb-20 px-4">
		...
		<div class="max-w-4xl mx-auto">
			<img
				...
				class="w-full h-auto mb-4 zooming"
				width="1200"
				height="948"
	...
	<section id="second" class="pageSection py-10 md:pt-40 md:pb-20 px-4">
		...
		<div class="max-w-2xl mx-auto zooming">
