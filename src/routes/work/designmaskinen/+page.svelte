...
<section class="grid max-w-[1297px] col-span-12 md:col-span-8 bg-blue-100 my-10 py-10">
	<div class="justify-left mx-5 md:mx-16 px-16 mt-40 mb-30">
		<div>
			<div>
				<h1 class="font-euclid text-8xl font-bold text-grey-800">Designmaskinen</h1>
			</div>
			<div>
				<h1 class="font-euclid text-6xl font-bold text-grey-600">
...
<section class="justify-center grid grid-cols-12">
	<div class="xl:col-span-6">
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			as only using brand colors. This approach ensures consistent design, a major selling point for
			the tool.
		</p>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			<a
				...
				target="_blank"
				rel="noopener"
				title="Designmaskinen">Netlife design - Designmaskinen</a
			>
		</p>
	</div>
	<div class="xl:col-span-6">
...
<section id="first" class="pageSection justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		<div>
			<h2 class="font-euclid text-xl font-bold text-grey-800">Understanding the Challenge</h2>
		</div>
		<div class="section">
			<h2 class="font-euclid text-xl font-bold text-grey-800">
				The main <span class="font-bold">challenge</span>
			</h2>
		</div>
		<p class="font-euclid text-base align-center text-grey-800">
			As Designmaskinen's user base grew, the earlier system of developers manually coding templates
			and handling CMS tasks became unsustainable. The solution? An admin area empowering customers
			to build templates and independently manage their brand assets.<br />
		</p>
	</div>
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			between different color themes on this template. The end result will automatically follow the
			brand guidelines.
		</p>
	</div>
	<div>
	...
	<div class="xl:col-span-12">
		<div class="ce-image" data-align="left">
			<img
				...
				width="2455"
				height="494"
				alt="User journey Designmaskinen"
			/>
		</div>
	</div>
	<div>
...
<section id="second" class="pageSection justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		<div>
			<h2 class="font-euclid text-xl font-bold text-grey-800">
		...
		<p class="font-euclid text-base align-center text-grey-800">
			Vertøykassa (the toolbox), is the core of the admin area. Here we decided to gather all brand
			assets. While I had a few initial sketches to guide me, I mostly relied on my own ideas for
			the design details.<br />
		</p>
	</div>
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			Some clients have many images so to avoid having hundreds of images in the assets toolbox, we
			decided to show only the latest three images, and put the rest of the images into an albums
			area. To figure out how this would look I first created paper sketches, then started to design
			and prototype in Figma. A key feature wanted was an option to categorise the images.&nbsp;<br
			/>
		</p>
	</div>
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			I worked in iterations, prototyping and testing to getting user feedback. My goal was to "fail
			fast" and move on to design improved versions. This first version was functional but had
		...
		<ul class="font-euclid text-base align-center text-grey-800">
			...
			<li>
				<strong>Modal Limitations:</strong> Editing was initially conceptualized in a modal window.
				But modals can disrupt user flow and pose mobile adaptation challenges.<br />
			</li>
		</ul>
	</div>
</section>
...
<section class="justify-center grid grid-cols-12">
	<div>
		<p class="font-euclid text-base align-center text-grey-800">
			After some rounds of prototyping, testing on users, team presentations, and iterations, I had
			a version that both the team and I were happy with. Highlighted features include:<br />
		</p>
		<ul class="font-euclid text-base align-center text-grey-800">
			<li>
			...
			<li>
				<strong>Keyboard Navigation:</strong> Easy to navigate using a keyboard. Simplified the tab
				visual que and removed the dropshadow.<br />
			</li>
		</ul>
	</div>
</section>
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			proposed reusing the same layout that I developed for the image albums. This suggestion would
			both ensure consistency, and address other issues we discussed.&nbsp;This ended up being the
			solution we used.&nbsp;<br />
		</p>
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			their user profile on a design app. so I opted for using the first letter of the user name as
			a placeholder - A clever trick that I believe designers for Google / Gmail came up with. This
			minimalist approach not only respects user preferences but also adds a touch of personalized
			elegance.<br />
		</p>
	</div>
</section>
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		...
		<p class="font-euclid text-base align-center text-grey-800">
			...
			intuitive manner, and ensuring consistency across the layout.<br />
		</p>
	</div>
	<div class="xl:col-span-9">
		<div class="ce-image" data-align="left">
...
<section class="justify-center grid grid-cols-12 xl:col-span-8">
	<div>
		<div class="section">
			<h2 class="font-euclid text-xl font-bold" style="color: #f3f2f4;">
				Test Drive my Final Prototype.&nbsp;
			</h2>
		</div>
		<p class="font-euclid text-base align-center" style="color: #fafafa;">
	...
	<div>
		...
		<ul class="font-euclid text-base align-center text-grey-800">
			<li>
				...
				at Netlife completely defied this image – they were actually super cool and down to earth! At
				the same time there were a lot of skilled and very collaborative people gathered in one environment
				and that was amazing. I learned a lot from my internship!
			</li>
			<li>
			...
			<li>
				<strong>Collaboration:</strong> Working in a cross-functional team with developers, having the
				developers in the same room as me. It made it quick to ideate and shoot ideas back and forth
