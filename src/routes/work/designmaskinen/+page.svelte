...
<article class="mx-auto text-grey-800 prose lg:prose-xl">
	<section class="max-w-5xl mx-auto justify-center pt-40 pb-20">
		<div class="">
			<h1 class="font-euclid text-7xl font-bold text-grey-800 py-4">Designmaskinen</h1>
			<h1 class="font-euclid text-4xl font-medium text-grey-600 py-4">
	...
	<section class="mt-20">
		<div>
			<h1 class="font-euclid text-3xl font-medium text-grey-800 text-center">Process overview</h1>
		</div>
	</section>
	...
	<section id="first" class="pageSection font-euclid bg-grey-800 text-white pt-40 pb-20">
	...
	<section id="second" class="pageSection pt-40 pb-20">
		<div class="max-w-xl mx-auto">
			<h2 class="font-euclid text-xl font-bold">Designing the brand assets toolbox</h2>
		...
		<div class="max-w-xl mx-auto">
			...
			<p class="font-euclid text-base">
				My design journey was a combination of exploration and refinement:
			</p>
			<ul class="font-euclid list-disc text-base">
				<li>
			...
			<p class="font-euclid text-base">For the finalized design, I integrated:</p>
			<ul class="font-euclid list-disc text-base">
	...
	>
		<div class="md:flex-1 md:max-w-md m-4">
			<div>
				...
				/>
				<p class="font-euclid text-base">Version 1.</p>
			</div>
		</div>
		<div class="md:flex-2 md:max-w-md m-4">
			<div>
				...
				/>
				<p class="font-euclid text-base">Version 2.&nbsp;</p>
			</div>
		</div>
		<div class="md:flex-3 md:max-w-md m-4">
			<div>
				...
				/>
				<p class="font-euclid text-base">Version 3 - final</p>
			</div>
		</div>
	</section>
	...
	<section class=" pt-40 pb-20">
		<div class="max-w-xl mx-auto">
			<h2 class="font-euclid text-xl font-bold">Designing the Image Album</h2>
			<p class="font-euclid text-base">
	...
	<section class=" pt-40 pb-20">
		...
		<div class="max-w-xl mx-auto">
			<ul class="font-euclid text-base align-center list-disc">
				<li>
